...
// Enhanced Hero with Profile Image
function Hero() {
  return (
    <section id="about" style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "80px 8vw 40px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ zIndex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center", width: "100%", maxWidth: 1200 }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
          ...
          <div style={{ position: "absolute", width: 450, height: 450, borderRadius: "50%", background: "radial-gradient(circle, #ff6b3510 0%, transparent 70%)", filter: "blur(40px)" }} />
          <div style={{ position: "absolute", width: 350, height: 350, borderRadius: "50%", background: "radial-gradient(circle, #7c3aed10 0%, transparent 70%)", filter: "blur(40px)" }} />
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow = "0 35px 60px rgba(255, 107, 53, 0.25), 0 0 2px rgba(255, 107, 53, 0.15)";
          }}
          onMouseLeave={e => {
            e.currentTarget.style.transform = "translateY(0)";
            e.currentTarget.style.boxShadow = "0 25px 50px rgba(255, 107, 53, 0.15), 0 0 1px rgba(255, 107, 53, 0.1)";
          }}>
            <img 
  ...
  return (
    <section id="education" style={{ padding: "100px 8vw" }}>
      ...
      <div style={{ maxWidth: 760, display: "grid", gap: 24 }}>
        {EDUCATION.map((e, i) => (
          <div key={i}
            style={{ background: "#0f172a", border: "1px solid #1e293b", borderRadius: 16, padding: "28px 30px", transition: "all 0.2s" }}
            onMouseEnter={el => { el.currentTarget.style.borderColor = e.color; el.currentTarget.style.transform = "translateX(8px)"; }}
            onMouseLeave={el => { el.currentTarget.style.borderColor = "#1e293b"; el.currentTarget.style.transform = "translateX(0)"; }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
              <span style={{ fontSize: 28 }}>{e.icon}</span>
              <div>
                <h3 style={{ fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 800, color: "#fff", margin: 0 }}>{e.degree}</h3>
                <p style={{ color: e.color, fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 13, marginTop: 2, margin: "2px 0 0" }}>{e.school}</p>
              </div>
            </div>
            ...
            <p style={{ color: "#94a3b8", fontSize: 14, margin: 0 }}>Focus: {e.focus}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section id="certifications" ref={ref} style={{ padding: "100px 8vw" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px,1fr))", gap: 18 }}>
        {CERTIFICATIONS.map((c, i) => (
          <div key={i}
            style={{ background: "#0f172a", border: `1px solid ${c.color}30`, borderRadius: 14, padding: "24px", textAlign: "center", transition: "all 0.2s", opacity: visible ? 1 : 0.5, transform: visible ? "translateY(0)" : "translateY(20px)" }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = c.color; e.currentTarget.style.transform = "translateY(-6px)"; e.currentTarget.style.boxShadow = `0 12px 24px ${c.color}15`; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = `${c.color}30`; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}>
            <div style={{ fontSize: 32, marginBottom: 12 }}>{c.icon}</div>
            <h4 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 14, color: "#fff", margin: 0, marginBottom: 6 }}>{c.title}</h4>
            <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#334155", margin: 0 }}>{c.issuer}</p>
          </div>
        ))}
      </div>
    </section>
  ...
  return (
    <section id="resume" style={{ padding: "100px 8vw" }}>
      ...
      <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(2rem,5vw,3.2rem)", fontWeight: 800, color: "#fff", margin: "12px 0 14px" }}>
        Download My <span style={{ color: "#ff6b35" }}>Resume</span>
      </h2>
      <p style={{ color: "#64748b", fontSize: 15, marginBottom: 48 }}>Get the full picture of my experience, education, and certifications.</p>
